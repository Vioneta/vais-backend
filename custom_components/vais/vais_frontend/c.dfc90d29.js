...
import { m as a } from './c.d0af35b1.js'
    ...
    return {
      ...
      d: [
        ...
        { kind: 'field', decorators: [i()], key: 'content', value: void 0 },
        {
          ...
          key: '_getRepository',
          value: () =>
            o((t, e) => (null == t ? void 0 : t.find((t) => t.id === e))),
        },
        {
          kind: 'method',
          key: 'render',
          value: function () {
            ...
            const t = this._getRepository(
              this.vais.repositories,
              this.repository
            )
            return s`
      <vais-dialog .active=${this.active} .narrow=${this.narrow} .hass=${
              this.hass
            }>
