...
import { a as w } from './c.7aca5ec5.js'
import './c.94b09f7e.js'
import { n as z } from './c.e61d287a.js'
import { s as j } from './c.51f71dd4.js'
import { m as R } from './c.d0af35b1.js'
import { u as C } from './c.5231233a.js'
import './c.8bde5a37.js'
import './c.80f50c51.js'
import './c.743a15a1.js'
import './c.d608b0a2.js'
e(
  [c('ha-expansion-panel')],
  function (e, a) {
    return {
      F: class extends a {
        constructor(...a) {
      ...
      d: [
        ...
        { kind: 'field', decorators: [t()], key: 'header', value: void 0 },
        { kind: 'field', decorators: [t()], key: 'secondary', value: void 0 },
        {
          kind: 'field',
          decorators: [i()],
          key: '_showContent',
    ...
    `
        ...
        },
        {
          ...
          value: async function (e) {
            ...
            l(this, 'expanded-will-change', { expanded: a }),
              a && ((this._showContent = !0), await z())
            const t = this._container.scrollHeight
            ;(this._container.style.height = `${t}px`),
              ...
              (this.expanded = a),
              l(this, 'expanded-changed', { expanded: this.expanded })
          },
        },
        {
          kind: 'get',
    ...
    return {
      ...
      d: [
        ...
        },
        {
          kind: 'field',
          key: '_getRepository',
          value: () => p((e, a) => e.find((e) => e.id === a)),
        },
        {
          kind: 'method',
          key: 'firstUpdated',
          value: async function (e) {
            m(u(i.prototype), 'firstUpdated', this).call(this, e)
            const a = this._getRepository(
              this.vais.repositories,
              this.repository
            )
            a &&
              ('commit' !== a.version_or_commit &&
                ((this._releaseNotes = await v(this.hass, a.id)),
                (this._releaseNotes = this._releaseNotes.filter(
                  (e) => e.tag > a.installed_version
                ))),
              g(this.hass, (e) => (this._error = e), y.ERROR))
          },
        },
        {
          kind: 'method',
      ...
      >
        <div class=${r({ content: !0, narrow: this.narrow })}>
          <p class="message">
            ${this.vais.localize('dialog_update.message', { name: a.name })}
          </p>
          <div class="version-container">
            <div class="version-element">
              <span class="version-number">${a.installed_version}</span>
              <small class="version-text">${this.vais.localize(
                  ...
                  (e) => o`
                    ...
                    >
                      ${
                        e.body
                          ? R.html(e.body, a)
                          : this.vais.localize('dialog_update.no_info')
                      }
                    </ha-expansion-panel>
                  `
                )
          ...
          ${
            a.can_install
              ? ''
              : o`<ha-alert alert-type="error" .rtl=${w(this.hass)}>
                  ${this.vais.localize(
                    'confirm.home_assistant_version_not_correct',
                    {
                      haversion: this.hass.config.version,
                      minversion: a.homeassistant,
                    }
                  )}
                </ha-alert>`
          }
          ${
            'integration' === a.category
              ? o`<p>${this.vais.localize('dialog_download.restart')}</p>`
              : ''
          }
          ${
            null !== (e = this._error) && void 0 !== e && e.message
              ? o`<ha-alert alert-type="error" .rtl=${w(this.hass)}>
                  ${this._error.message}
                </ha-alert>`
              : ''
        ...
        <mwc-button
          ...
          ${
            this._updating
              ? o`<ha-circular-progress active size="small"></ha-circular-progress>`
        ...
        <div class="secondary" slot="secondaryaction">
          ...
          <vais-link .url="https://github.com/${a.full_name}">
    ...
    `
        ...
        },
        {
          ...
          value: async function () {
            ...
            e &&
              ('commit' !== e.version_or_commit
                ? await x(this.hass, e.id, e.available_version)
                : await _(this.hass, e.id),
              'plugin' === e.category &&
                'storage' === this.vais.status.lovelace_mode &&
                (await C(this.hass, e, e.available_version)),
              (this._updating = !1),
              this.dispatchEvent(
              ...
              'plugin' === e.category &&
                j(this, {
                  ...
                  confirm: () => {
                    k.location.href = k.location.href
                  },
                }))
          },
        },
        {
          ...
          value: function () {
            ...
            if (e)
              return 'commit' === e.version_or_commit
                ? `https://github.com/${e.full_name}/compare/${e.installed_version}...${e.available_version}`
                : `https://github.com/${e.full_name}/releases`
          },
        },
        {
          kind: 'get',
