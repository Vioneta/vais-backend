...
import { i as $ } from './c.6d29ff99.js'
import { a as C } from './c.7aca5ec5.js'
import './c.94b09f7e.js'
import { L, s as D } from './c.08c9f9b1.js'
import { b as H } from './c.be11274c.js'
import { s as F } from './c.3e1d4eb7.js'
import './c.d0af35b1.js'
import './c.743a15a1.js'
import './c.8bde5a37.js'
import './c.51f71dd4.js'
var B = new Set()
const A = [
    {
      properties: {
      ...
      _onIronRequestResizeNotifications: function (t) {
        var i = e(t).rootTarget
        i !== this &&
          (i.assignParentResizable(this),
          this._notifyDescendant(i),
          t.stopPropagation())
      },
      ...
      _findParent: function () {
        this.assignParentResizable(null),
          ...
          this._parentResizable ? B.delete(this) : B.add(this)
      },
    },
    {
      listeners: {
      ...
      _appResetLayoutHandler: function (t) {
        e(t).path[0] !== this && (this.resetLayout(), t.stopPropagation())
      },
      ...
      resetLayout: function () {
        ...
        ;(this._layoutDebouncer = i.debounce(this._layoutDebouncer, s, t)),
          o(this._layoutDebouncer),
  ...
  M = {
    ...
    _scrollTargetChanged: function (t, i) {
      if (
        ...
        if ('document' === t) this.scrollTarget = this._doc
          ...
          var s = this.domHost
          this.scrollTarget =
            s && s.$ ? s.$[t] : e(this.ownerDocument).querySelector('#' + t)
        } else
        ...
        var i = parseFloat(e.startsAt || 0),
          ...
          a =
            0 === i && 1 === s
              ? t.run
              : function (e, s) {
                  t.run.call(this, Math.max(0, (e - i) / o), s)
                }
        return {
          setUp: t.setUp ? t.setUp.bind(this, e) : n,
          run: t.run ? a.bind(this) : n,
          tearDown: t.tearDown ? t.tearDown.bind(this) : n,
        }
      },
...
`,
  ...
  get _stickyEl() {
    ...
    for (
      var t, i = e(this.$.slot).getDistributedNodes(), s = 0;
      (t = i[s]);
      s++
    )
  ...
  _updateScrollState: function (t, e) {
    if (0 !== this._height) {
      var i = 0,
        ...
        o = this._top
      this._lastScrollTop
      var n = this._maxHeaderTop,
        a = t - this._lastScrollTop,
        r = Math.abs(a),
        l = t > this._lastScrollTop,
        d = performance.now()
      if (
        (this._mayMove() && (s = this._clamp(this.reveals ? o + a : t, 0, n)),
        t >= this._dHeight &&
          ((s = this.condenses && !this.fixed ? Math.max(this._dHeight, s) : s),
          (this.style.transitionDuration = '0ms')),
        this.reveals &&
          !this.disabled &&
          r < 100 &&
          ((d - this._initTimestamp > 300 || this._wasScrollingDown !== l) &&
            ((this._initScrollTop = t), (this._initTimestamp = d)),
          t >= n))
      )
        if (Math.abs(this._initScrollTop - t) > 30 || r > 10) {
          l && t >= n
            ? (s = n)
            : !l &&
              t >= this._dHeight &&
              (s = this.condenses && !this.fixed ? this._dHeight : 0)
          var c = a / (d - this._lastTimestamp)
          this.style.transitionDuration =
            this._clamp((s - o) / c, 0, 300) + 'ms'
        } else s = this._top
  ...
  _ensureBgContainers: function () {
    this._bgContainer ||
      ...
      e(this.root).insertBefore(this._bgContainer, this.$.contentContainer))
  },
  _getDOMRef: function (t) {
    switch (t) {
      ...
      case 'mainTitle':
        return e(this).querySelector('[main-title]')
      case 'condensedTitle':
        return e(this).querySelector('[condensed-title]')
    }
    return null
  },
...
`,
    ...
    get header() {
      return e(this.$.headerSlot).getDistributedNodes()[0]
    },
    _updateLayoutStates: function () {
      var t = this.header
...
class I extends customElements.get('app-header-layout') {
  static get template() {
    return a`
      <style>
        :host {
...
customElements.define('ha-app-layout', I)
const W = (t, e) =>
    e.component
      ? $(t, e.component)
      : !e.components || e.components.some((e) => $(t, e)),
  U = (t) => t.core,
  j = (t, e) =>
    ((t) => t.advancedOnly)(e) &&
    !((t) => {
      var e
      return null === (e = t.userData) || void 0 === e ? void 0 : e.showAdvanced
    })(t)
  ...
  class extends r {
    connectedCallback() {
      super.connectedCallback(),
        setTimeout(() => {
          this.path = 'ltr' === window.getComputedStyle(this).direction ? l : d
        }, 100)
    }
  }
),
  c(
    [y('ha-clickable-list-item')],
    function (t, e) {
      class i extends e {
        constructor(...e) {
          super(...e), t(this)
      ...
      return {
        F: i,
        d: [
          { kind: 'field', decorators: [h()], key: 'href', value: void 0 },
          {
            kind: 'field',
            decorators: [h({ type: Boolean })],
            key: 'disableHref',
            value: () => !1,
          },
          {
            kind: 'field',
            decorators: [h({ type: Boolean, reflect: !0 })],
            key: 'rtl',
            value: () => !1,
          },
          {
          ...
          },
          {
            ...
            key: 'render',
            value: function () {
              const t = u(f(i.prototype), 'render', this).call(this),
                e = this.href || ''
              return g`${
                this.disableHref
                  ? g`<a aria-role="option">${t}</a>`
                  : g`<a
          aria-role="option"
        ...
        >`
          ...
          },
          {
            ...
            key: 'firstUpdated',
            value: function () {
              u(f(i.prototype), 'firstUpdated', this).call(this),
                this.addEventListener('keydown', (t) => {
                  ;('Enter' !== t.key && ' ' !== t.key) || this._anchor.click()
                })
            },
          },
          {
        ...
        ${this.pages.map(
          (t) => g`
            ...
            >
              ...
              ${
                this.hasSecondary
                  ? g`<span slot="secondary">${t.description}</span>`
                  : ''
              }
  ...
  c(
              ...
              const t = this.pages
                .filter((t) => {
                  ...
                  return '#external-app-configuration' === t.path
                    ...
                    : ((t, e) => (U(e) || W(t, e)) && !j(t, e))(this.hass, t)
                })
                .map((t) => ({
                  ...t,
                  name:
    ...
    `
          ...
          },
          {
            ...
            value: function (t) {
              var e
              const i = t.composedPath().find((t) => 'A' === t.tagName)
              null != i &&
                null !== (e = i.href) &&
                void 0 !== e &&
  ...
  c(
    ...
    function (t, e) {
      return {
        ...
        d: [
          { kind: 'field', decorators: [h()], key: 'isWide', value: () => !1 },
          {
            kind: 'field',
            decorators: [h({ type: Boolean })],
            key: 'vertical',
          ...
          {
            kind: 'field',
            decorators: [h({ type: Boolean, attribute: 'full-width' })],
            key: 'fullWidth',
            value: () => !1,
          },
          {
...
const P = b((t, e) => {
  ...
  var l, d
  return (
    t.repositories.forEach((e) => {
      var i
      if (
        ('pending-restart' === e.status && r.push(e),
        t.addedToLovelace(t, e) || a.push(e),
        e.installed &&
          null !== (i = t.removed.map((t) => t.repository)) &&
          void 0 !== i &&
          i.includes(e.full_name))
      ) {
        const i = t.removed.find((t) => t.repository === e.full_name)
        n.push({
          name: t.localize('entry.messages.removed_repository', {
    ...
    null !== (i = t.status) &&
      void 0 !== i &&
      i.startup &&
      ['setup', 'waiting', 'startup'].includes(t.status.stage) &&
      n.push({
        name: t.localize(`entry.messages.${t.status.stage}.title`),
        info: t.localize(`entry.messages.${t.status.stage}.content`),
        severity: 'warning',
      }),
    null !== (s = t.status) &&
      void 0 !== s &&
      s.has_pending_tasks &&
      n.push({
        name: t.localize('entry.messages.has_pending_tasks.title'),
        info: t.localize('entry.messages.has_pending_tasks.content'),
        severity: 'warning',
      }),
    null !== (o = t.status) && void 0 !== o && o.disabled
      ? [
          {
            name: t.localize('entry.messages.disabled.title'),
            secondary: t.localize(
              `entry.messages.disabled.${
      ...
      : (a.length > 0 &&
          n.push({
            name: t.localize('entry.messages.resources.title'),
            info: t.localize('entry.messages.resources.content', {
              number: a.length,
            }),
            severity: 'error',
          }),
        r.length > 0 &&
          n.push({
            name: t.localize('entry.messages.restart.title'),
            path: e ? '/_my_redirect/server_controls' : void 0,
            info: t.localize('entry.messages.restart.content', {
              number: r.length,
              pluralWording:
                1 === r.length
                  ? t.localize('common.integration')
                  : t.localize('common.integration_plural'),
            }),
            severity: 'error',
          }),
        n)
  ...
  function (t, e) {
      ...
      d: [
        ...
        },
        {
          ...
          value: function () {
            ...
            const i = [],
              s = [],
              o = P(this.vais, $(this.hass, 'my'))
            return (
              this.vais.repositories.forEach((t) => {
                t.pending_upgrade && i.push(t)
              }),
              o.forEach((t) => {
                s.push({
                  iconPath: k,
      ...
      <ha-app-layout>
        <app-header fixed slot="header">
          <app-toolbar>
            ...
            <div main-title>${
              this.narrow ? 'VAIS' : 'Home Assistant Community Store'
            }</div>
          </app-toolbar>
        </app-header>
        <ha-config-section .narrow=${this.narrow} .isWide=${
          ...
          ${
            0 !==
            (null === (t = this.vais.messages) || void 0 === t
              ? void 0
              : t.length)
              ? this.vais.messages.map(
                  (t) => g`
                    <ha-alert
                      .alertType=${t.severity}
                      .title=${
                        t.secondary ? `${t.name} - ${t.secondary}` : t.name
                      }
                      .rtl=${C(this.hass)}
                    >
                      ${t.info}
                      <mwc-button
                        ...
                        .label=${
                          t.path
                            ? this.vais.localize('common.navigate')
                            : t.dialog
                            ? this.vais.localize('common.show')
                            : ''
                        }
                        @click=${() =>
                          t.path ? w(t.path) : this._openDialog(t)}
                      >
                      </mwc-button>
                    </ha-alert>
                  `
          ...
          ${
            0 !==
            (null === (e = this.vais.updates) || void 0 === e
              ? void 0
              : e.length)
              ? g` <ha-card outlined>
                <div class="title">${this.vais.localize('common.updates')}</div>
                ${x(this.vais.updates).map(
                  (t) => g`
                        ...
                        <div class="list-item-content">
                          ...
                          <div class="list-item-description">
                            ${this.vais.localize(
                              ...
                              {
                                downloaded: t.installed_version,
                                available: t.available_version,
                              }
                            )}
                          </div>
                        </div>
          ...
          <ha-card outlined>
            ...
            <div class="list-item" @click=${this._openAboutDialog}>
              ...
              <div class="list-item-content">
                <div class="list-item-header">${this.vais.localize(
    ...
    `
        ...
        },
        {
          ...
          key: '_onImageLoad',
          value: function (t) {
            t.target.style.visibility = 'initial'
          },
        },
        {
          kind: 'method',
        ...
        },
        {
          ...
          value: function (t) {
            t.dialog &&
              ('remove' == t.dialog && (t.dialog = 'removed'),
              this.dispatchEvent(
                new CustomEvent('vais-dialog', {
                  detail: { type: t.dialog, repository: t.repository },
                  bubbles: !0,
                  composed: !0,
                })
              ))
        ...
        {
          kind: 'method',
          key: '_openUpdateDialog',
          value: function (t) {
            this.dispatchEvent(
              new CustomEvent('vais-dialog', {
                detail: { type: 'update', repository: t.id },
                bubbles: !0,
                composed: !0,
              })
            )
        ...
        {
          kind: 'method',
          key: '_openSupervisorDialog',
          value: async function () {
            this.dispatchEvent(
              new CustomEvent('vais-dialog', {
                detail: { type: 'navigate', path: '/hassio' },
                bubbles: !0,
                composed: !0,
              })
            )
