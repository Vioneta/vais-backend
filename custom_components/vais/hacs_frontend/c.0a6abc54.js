...
class y extends s {
          ...
          if (this.indeterminate)
            for (const e of r)
              if (e.contentRect) {
                ...
                this.calculateAndSetAnimationDimensions(r)
              }
        })),
  ...
  calculateAndSetAnimationDimensions(r) {
    const e = 0.8367142 * r,
      ...
      s = 0.84386165 * r,
      t = 1.60277782 * r
    ;(this.stylePrimaryHalf = `${e}px`),
      (this.stylePrimaryFull = `${a}px`),
      (this.styleSecondaryQuarter = `${i}px`),
      (this.styleSecondaryHalf = `${s}px`),
      (this.styleSecondaryFull = `${t}px`),
      this.restartAnimation()
  }
...
r([e('.mdc-linear-progress')], y.prototype, 'rootEl', void 0),
  r([a({ type: Boolean, reflect: !0 })], y.prototype, 'indeterminate', void 0),
  r([a({ type: Number })], y.prototype, 'progress', void 0),
  r([a({ type: Number })], y.prototype, 'buffer', void 0),
  r([a({ type: Boolean, reflect: !0 })], y.prototype, 'reverse', void 0),
  r([a({ type: Boolean, reflect: !0 })], y.prototype, 'closed', void 0),
  r(
    [
      function (r, e, a) {
        if (void 0 !== e)
          return (function (r, e, a) {
            ...
            if (!a) {
              const r = `__${e}`
              if (!(a = i.getPropertyDescriptor(e, r)))
                throw new Error(
            ...
            if (r.dispatchWizEvent) return a
            const n = {
              configurable: !0,
              enumerable: !0,
              set(r) {
                if ('' === t) {
                  const r = i.getPropertyOptions(e)
                  t = 'string' == typeof r.attribute ? r.attribute : e
                }
  ...
  r([i()], y.prototype, 'stylePrimaryHalf', void 0),
  r([i()], y.prototype, 'stylePrimaryFull', void 0),
  r([i()], y.prototype, 'styleSecondaryQuarter', void 0),
  r([i()], y.prototype, 'styleSecondaryHalf', void 0),
  r([i()], y.prototype, 'styleSecondaryFull', void 0),
  r([i()], y.prototype, 'animationReady', void 0),
  r([i()], y.prototype, 'closedAnimationOff', void 0)
...
;(b.styles = [u]), (b = r([d('mwc-linear-progress')], b))
let h = m(
  [d('vais-navigate-dialog')],
  function (r, e) {
    return {
      F: class extends e {
        constructor(...e) {
      ...
      d: [
        { kind: 'field', decorators: [a()], key: 'path', value: void 0 },
        { kind: 'field', decorators: [i()], key: '_progress', value: () => 0 },
        {
          kind: 'method',
          key: 'firstUpdated',
      ...
      <vais-dialog
        ...
        .active=${this.active}
        .hass=${this.hass}
        title="Navigating away from VAIS"
      >
        <div class="content">
          This takes you away from VAIS and to another page, what you see on that page is not a part
          of VAIS.
          <br /><br />
...
export { h as VaisNavigateDialog }
