  ...
  function (t, e) {
    return {
      ...
      d: [
        ...
        { kind: 'field', decorators: [r()], key: 'url', value: void 0 },
        {
          kind: 'method',
          key: 'render',
          value: function () {
            return n`<span title=${this.title || this.url} @click=${
              this._open
            }><slot></slot></span>`
          },
        },
        {
          ...
          value: function () {
            ...
            if (this.url.startsWith('/') && !this.newtab)
              return void i(this.url, { replace: !0 })
            const e =
              null === (t = this.url) || void 0 === t
                ? void 0
                : t.startsWith('http')
            let r = '',
              n = '_blank'
            e && (r = 'noreferrer=true'),
              e || this.newtab || (n = '_blank'),
              e || this.parent || (n = '_parent'),
              a.open(this.url, n, r)
          },
        },
        {
