...
from custom_components.vais.utils import regex


def test_extract_repository_from_url():
    """Tests for repository extraction."""
    assert regex.extract_repository_from_url(
    ...
    assert not regex.extract_repository_from_url(
        "https://google.com/user/repo")
